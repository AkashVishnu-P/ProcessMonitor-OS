...
import '../widgets/process_state_flow_widget.dart';
import '../widgets/memory_visualization_widget.dart';
import '../widgets/results_metrics_widget.dart';
import '../widgets/professor_mode_dialog.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // 8. Process State Visualization Diagram (Module 8)
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
            child: ProcessStateFlowWidget(
              runningProcess: sim.runningProcess,
              readyCount: sim.readyQueue.length,
              waitingCount: sim.waitingQueue.length,
              terminatedCount: sim.terminatedList.length,
            ),
          ),

          // 9. Simulated RAM Memory Allocation Widget (Module 9)
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
            child: MemoryVisualizationWidget(
              totalMemoryMb: sim.totalMemoryMb,
              kernelMemoryMb: sim.kernelMemoryMb,
              runningProcess: sim.runningProcess,
              readyQueue: sim.readyQueue,
              waitingQueue: sim.waitingQueue,
            ),
          ),

          // 10. Simulation Results & Performance Metrics (Module 7)
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
            child: ResultsMetricsWidget(
              terminatedList: sim.terminatedList,
              averageWaitingTime: sim.averageWaitingTime,
              averageTurnaroundTime: sim.averageTurnaroundTime,
              averageResponseTime: sim.averageResponseTime,
              cpuUtilization: sim.cpuUtilization,
              throughput: sim.throughput,
              totalContextSwitches: sim.totalContextSwitches,
              cpuIdleTicks: sim.cpuIdleTicks,
            ),
          ),
      ...
      floatingActionButton: Row(
        ...
        children: [
          FloatingActionButton.extended(
            ...
            onPressed: () => ProfessorModeBottomSheet.show(context, sim),
          ),
